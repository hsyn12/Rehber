...
public class Spans {
	...
	/*public static Span backgroundPadding() {
		
		return new Span(RoundedBackground.builder().build());
	}*/
	
	/*public static Span backgroundPadding(int backgroundColor) {
		
		return new Span(RoundedBackground.builder()
				.backgroundColor(backgroundColor).build());
	}*/
	
	/*public static Span backgroundPadding(int backgroundColor, int textColor) {
	...
	/*public static Span backgroundPadding(int backgroundColor, int textColor, float padding) {
	...
	/*public static Span backgroundPadding(int backgroundColor, int textColor, float padding, int cornerRadius) {
		
		return new Span(RoundedBackground.builder()
				.backgroundColor(backgroundColor)
				.textColor(textColor)
				.padding(padding)
				.cornerRadius(cornerRadius).build());
	}*/
	
	/*public static Span backgroundPadding(int backgroundColor, int textColor, float padding, int cornerRadius, int paddingTop, int paddingBottom) {
	 ...
	 */
	public static com.tr.hsyn.text.ImageSpan image(@NonNull final Drawable drawable) {
		
		return new com.tr.hsyn.text.ImageSpan(() -> new ImageSpan(drawable));
	}
	 ...
	 */
	public static com.tr.hsyn.text.ImageSpan image(@NonNull final Drawable drawable, final int verticalAlignment) {
		
		return new com.tr.hsyn.text.ImageSpan(() -> new ImageSpan(drawable, verticalAlignment));
	}
	
	/**
	 * @see ImageSpan#ImageSpan(Context, int, int)
	 */
	public static com.tr.hsyn.text.ImageSpan image(final Context context, @DrawableRes final int drawableId, final int verticalAlignment) {
		
		return new com.tr.hsyn.text.ImageSpan(() -> new ImageSpan(context, drawableId, verticalAlignment));
	}
	
	/**
	 * @see ImageSpan#ImageSpan(Context, int)
	 */
	public static com.tr.hsyn.text.ImageSpan image(final Context context, @DrawableRes final int drawableId) {
		
		return new com.tr.hsyn.text.ImageSpan(() -> new ImageSpan(context, drawableId));
	}
	...
	public static Span image(@NonNull final Context context, final Bitmap bitmap, final int verticalAlignment) {
		...
		return new Span(() -> new ImageSpan(context, bitmap, verticalAlignment));
	}
	...
	public static Span click(@NonNull final View.OnClickListener onClickListener, int textColor) {
		
		return new Span(new ClickSpanBuilder(onClickListener, textColor));
	}
	...
	public static Span url(@NonNull final String url) {
		...
		return new Span(() -> new URLSpan(url));
	}
	...
	public static Span edit() {
		...
		return new Span(EasyEditSpan::new);
	}
