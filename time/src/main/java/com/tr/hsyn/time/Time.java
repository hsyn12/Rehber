...
public class Time implements TimeMillis {
    ...
    private Time() {this(new Date(currentMillis()));}
     ...
     */
    @NotNull
    public static Time now() {return new Time();}
     ...
     * @return Bir zaman
     */
    public static long randomDate() {return Randoom.getLong(currentMillis());}
    ...
    @NotNull
    public static String ToString() {return toString(currentMillis(), DEFAULT_DATE_TIME_PATTERN);}
