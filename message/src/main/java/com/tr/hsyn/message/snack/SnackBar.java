...
import com.tr.hsyn.message.IMessage;
...
public class SnackBar {
	...
	public static SnackBarItem sbi(final Activity activity, @NonNull final CharSequence msg, long durationMilis, boolean cancel, long delay, SnackBarListener snackBarListener, View.OnClickListener clickListener, CharSequence actionMessage, int messageType) {
		...
		switch (messageType) {
			...
			case IMessage.INFO:
				break;
			case IMessage.WARN:
				icon = R.drawable.loader_w;
				break;
			case IMessage.ERROR:
				icon = R.drawable.loader_e;
			
		}
		
		
		SnackBarItem.Builder snack = new SnackBarItem.Builder(activity)
				.setDrawable(icon)
