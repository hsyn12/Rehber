package com.tr.hsyn.message.snack;
...
public class SnackBarItem {
	...
	public void setTextLineSize(int textLineSize) {
		
		this.textLineSize = textLineSize;
	}
	...
	private void createShowAnimation(@NonNull TextView message, @Nullable Button action) {
		...
		if (mAutoDismiss) {
			appearAnimations.add(ObjectAnimator.ofFloat(mSnackBarView, "alpha", 1f, 1.0f).setDuration(mAnimationDuration));
	...
	private Animator getAppearAnimation(@NonNull TextView message, @Nullable Button action) {
		...
		if (mSpannerMessage != null) {
			...
			textLineSize = getLineCountOfTextViewBeforeRendering(mActivity, mMessageString.toString());
		}
	...
	void show() {
		...
		messageTV = mSnackBarView.findViewById(R.id.message);
	...
	public static class Builder {
		...
		public Builder setActionMessageColorResource(@ColorRes int color) {
			...
			mSnackBarItem.mActionColor = mResources.getColor(color, mResources.newTheme());
			return this;
		}
		...
		public Builder setSnackBarBackgroundColorResource(@ColorRes int color) {
			...
			mSnackBarItem.mSnackBarColor = mResources.getColor(color, mResources.newTheme());
			return this;
		}
		...
		public Builder setSnackBarMessageColorResource(@ColorRes int color) {
			...
			mSnackBarItem.mMessageColor = mResources.getColor(color, mResources.newTheme());
			return this;
		}
