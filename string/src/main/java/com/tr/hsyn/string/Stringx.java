...
public final class Stringx {
	...
	/**
	 * Tüm karakterlerin alfabetic olup olmadığını test eder.
	 * Boşluk karakterleri de teste dahil.
	 * Alfabetik olmayan bir karakter sonucu {@code false} yapar
	 *
	 * @param str String
	 * @return Alfabetik ise {@code true}
	 */
	public static boolean isAlphabetic(@NotNull String str) {
		
		for (char c : str.toCharArray()) if (!Character.isAlphabetic(c)) return false;
	 ...
	 * @return text
	 */
	public static String format(CharSequence text, Object... args) {
		
		return String.format(new Locale("tr", "TR"), text.toString(), args);
	}
