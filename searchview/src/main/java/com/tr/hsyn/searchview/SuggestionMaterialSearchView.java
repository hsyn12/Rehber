...
import com.tr.hsyn.searchview.adapter.SearchSuggestRvAdapter;
...
public class SuggestionMaterialSearchView extends BaseMaterialSearchView implements RecyclerItemClickListener.OnItemClickListener, Filter.FilterListener {
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a != null) {
            if (a.hasValue(R.styleable.BaseMaterialSearchView_msvHideShadow)) {
                hideShadow = a.getBoolean(R.styleable.BaseMaterialSearchView_msvHideShadow, false);
            }
