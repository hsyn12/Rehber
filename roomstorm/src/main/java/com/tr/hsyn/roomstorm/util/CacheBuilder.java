...
package com.tr.hsyn.roomstorm.util;
...
import com.tr.hsyn.roomstorm.FieldsParser;
import com.tr.hsyn.roomstorm.StormUriCreator;
...
public class CacheBuilder {
    ...
    public @NonNull
    CachedTable buildTableCache(@NonNull Class<?> clazz) {
