...
public class ReColor {
	...
	private final Handler         timerHandler = new Handler(Looper.getMainLooper(), null);
	...
	public ReColor(@NonNull Context context) {
		...
		if (windowManager != null) {
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
				colorChangeSpeed = (int) (1000 / context.getDisplay().getRefreshRate());
			}
			else {
	...
	private final Runnable menuIconColorTimerRunnable      = new Runnable() {
		...
		public void run() {
			...
			try {
				...
				if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
					...
					menuItemIcon.setColorFilter(new BlendModeColorFilter(lastShownColor, BlendMode.SRC_IN));
				}
				else {
	...
	private final Runnable imageButtonTimerRunnable        = new Runnable() {
	...
	private final Runnable navigationBarColorTimerRunnable = new Runnable() {
	...
	private final Runnable statusBarColorTimerRunnable     = new Runnable() {
	...
	private final Runnable viewBackgroundTimerRunnable = new Runnable() {
	...
	private final Runnable imageViewColorFilterTimerRunnable = new Runnable() {
	...
	private final Runnable textColorTimerRunnable            = new Runnable() {
	...
	private final Runnable cardViewBackgroundTimerRunnable = new Runnable() {
		@Override
		public void run() {
