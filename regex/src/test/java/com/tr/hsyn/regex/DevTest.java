...
public class DevTest {
	...
	public void devAfterLast() throws Exception {
		...
		String result = Nina.Dev.afterLast("hsyntr@33@gmail.com", "@");
	...
	public void devAfterFirst() throws Exception {
		...
		String result = Nina.Dev.afterFirst("hsyntr@33@gmail.com", "@");
	...
	public void devBeforeLast() throws Exception {
		...
		String result = Nina.Dev.beforeLast("hsyntr@33@gmail.com", "@");
	...
	public void devBeforeFirst() throws Exception {
		...
		String result = Nina.Dev.beforeFirst("hsyntr@33@gmail.com", "@");
