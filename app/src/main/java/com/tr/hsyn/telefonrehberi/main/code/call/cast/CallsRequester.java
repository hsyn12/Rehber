...
public class CallsRequester implements ContentRequester<SystemCall> {
    ...
    private final ContentHandler<SystemCall> contentHandler = new ContentHandler<>() {
        ...
        @NotNull
        @Override
        public SystemCall handle(@NonNull Cursor cursor) {
    ...
    @NotNull
    @Override
    public ContentHandler<SystemCall> getContentHandler() {
