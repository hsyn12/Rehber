...
import com.tr.hsyn.telefonrehberi.main.activity.call.backup.adapter.AdapterCallBackup;
import com.tr.hsyn.telefonrehberi.code.ViewFinder;
...
public abstract class CallBackupActivityView extends ActivityView implements ItemIndexListener {
    ...
    protected void onCreate() {
        ...
        Colors.setProgressColor(progress.get(this));

        list.get(this).setAdapter(adapter);
    }
    ...
    protected void showProgress(boolean show) {
        ...
        progress.get(this).setVisibility(show ? View.VISIBLE : View.GONE);
    }
