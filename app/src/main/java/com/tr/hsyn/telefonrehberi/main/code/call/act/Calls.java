...
public interface Calls {
    ...
    /**
     * Sistemin arama kayıtlarına ekleme yap.
     *
    ...
    static String createExtraInfo(@NonNull SystemCall call) {

        return String.format("%s;%s;%d", ACCOUNT_ID, call.isRandom() ? "t" : "f", call.getTrackType());
