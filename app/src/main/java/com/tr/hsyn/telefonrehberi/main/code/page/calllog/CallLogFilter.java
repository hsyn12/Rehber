...
public abstract class CallLogFilter extends CallList implements Filter, HaveCallAction, BackPressObserver {
    ...
    private void showMostCalls(int filter) {
        ...
        Blue.box(BuildKeys.MOST_CALLS_FILTER_TYPE, filter);
    ...
    private void setFilterAdapter() {
        ...
        if (filteredCalls != null) {
            ...
            Blue.box(BuildKeys.CALL_LOG_SEARCH_INFO, new CallLogSearchInfo(filteredCalls, filter));
        }
        else {
    ...
    private void filterAll() {
        ...
        Blue.box(BuildKeys.CALL_LOG_SEARCH_INFO, new CallLogSearchInfo(getList(), filter));
