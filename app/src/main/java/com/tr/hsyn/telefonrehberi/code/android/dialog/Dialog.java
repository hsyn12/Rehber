...
public interface Dialog {
    ...
    public static View inflate(@NonNull Activity activity, int id) {
    ...
    public static void openMessageDialog(Activity activity, CharSequence message) {
    ...
    @NonNull
    public static AlertDialog createDialog(Activity activity, View layout) {
    ...
    public static boolean hasOpenedDialogs(@NonNull AppCompatActivity activity) {
