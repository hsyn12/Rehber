...
public interface SystemContacts {
	 ...
	 *
	 * @param resolver the ContentResolver object used to interact with the phone's contacts
	 * @param name     the name of the contact to be added
	 * @param number   the phone number of the contact to be added
	 *
	 * @return {@code true} if the contact was successfully added, {@code false} otherwise
	 */
