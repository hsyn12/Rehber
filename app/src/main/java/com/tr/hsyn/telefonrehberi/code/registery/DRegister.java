 ...
 *
 * <ul>
 *    <li>{@link #DRegister()}</li>
 *    <li>{@link #DRegister(String)}</li>
 *    <li>{@link #DRegister(ContentResolver)}</li>
 *    <li>{@link #DRegister(ContentResolver, String)}</li>
 * </ul>
 */
public class DRegister implements Register {
    ...
    public DRegister(@NonNull String directoryName) {
	...
	*/
    ...
    public DRegister(@NonNull ContentResolver resolver) {

        this(resolver, DEFAULT_ROOM);
    }

    public DRegister(@NonNull ContentResolver resolver, @NonNull String directoryName) {
    ...
    public DRegister(@NonNull ContentResolver resolver, @NonNull DocumentFile directory) {
     ...
     */
    public DRegister(@NonNull ContentResolver resolver, @NonNull DocumentFile mainDirectory, @NonNull String directoryName) {
