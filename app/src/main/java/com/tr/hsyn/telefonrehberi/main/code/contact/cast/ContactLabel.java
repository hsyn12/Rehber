...
import com.tr.hsyn.telefonrehberi.code.Try;
...
public interface ContactLabel extends Mabel {
	...
	/**
	 * Returns a {@link Set} of {@link Label}s for the given {@link CLabel} IDs.
	 *
	 * @param labelIds the {@link CLabel} IDs
	 * @return a {@link Set} of {@link Label}s for the given {@link CLabel} IDs
	 */
	@NotNull
	static Set<Label> getLabels(@NonNull @CLabel int[] labelIds) {
