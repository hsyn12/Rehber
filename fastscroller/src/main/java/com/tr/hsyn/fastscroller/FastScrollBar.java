...
package com.tr.hsyn.fastscroller;
...
public class FastScrollBar {
    ...
    private final        int             thumbMinWidth;
    private final        int             thumbMaxWidth;
    private final        Paint           trackPaint;
    // The inset is the buffer around which a point will still register as a click on the scrollbar
    private final        int             touchInset;
    private final        boolean         showThumbCurvature;
    ...
    public FastScrollBar(FastScrollRecyclerView rv, AttributeSet attrs) {
        ...
        thumbInactiveColor = ta.getColor(R.styleable.FastScrollRecyclerView_fastScrollThumbInactiveColor,
                res.getColor(R.color.fastscroll_thumb_inactive_color, null));
        thumbActiveColor   = ta.getColor(R.styleable.FastScrollRecyclerView_fastScrollThumbActiveColor,
                res.getColor(R.color.fastscroll_thumb_active_color, null));
        int trackColor = ta.getColor(R.styleable.FastScrollRecyclerView_fastScrollTrackColor, Color.TRANSPARENT);
        ta.recycle();
        recyclerView    = rv;
     ...
     */
    public void animateScrollbar(boolean isScrolling) {
        ...
        if (thumbActiveColor != thumbInactiveColor) {
            ...
            ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), thumbPaint.getColor(), isScrolling ? thumbActiveColor : thumbInactiveColor);
            colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animator) {
                    ...
                    //recyclerView.invalidate(thumbOffset.x, thumbOffset.y, thumbOffset.x + thumbWidth, thumbOffset.y + thumbHeight);
                    recyclerView.invalidate();
                }
            });
    ...
    public void setThumbOffset(int x, int y) {
        ...
        invalidateRect.set(thumbOffset.x - thumbCurvature, thumbOffset.y, thumbOffset.x + thumbWidth, thumbOffset.y + thumbHeight);
        thumbOffset.set(x, y);
        updateThumbPath();
        invalidateRect.union(thumbOffset.x - thumbCurvature, thumbOffset.y, thumbOffset.x + thumbWidth, thumbOffset.y + thumbHeight);
    ...
    private void updateThumbPath() {
        ...
        thumbPath.cubicTo(thumbOffset.x, thumbOffset.y + thumbHeight,
                ...
                thumbOffset.y + (float) thumbHeight / 2,
