...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    protected void getCurScrollState(ScrollPositionState stateOut) {
        ...
        stateOut.rowTopOffset = Objects.requireNonNull(getLayoutManager()).getDecoratedTop(child) / (float) child.getHeight();
    ...
    protected boolean shouldStopScroll(MotionEvent ev) {
        ...
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            return Math.abs(lastDy) < deltaThreshold && getScrollState() != RecyclerView.SCROLL_STATE_IDLE;
        }
    ...
    public void setFastScrollListener(FastScrollListener fastScrollListener) {
        ...
        fastScrollBar.fastScrollListener = fastScrollListener;
    }
    ...
    /**
     * Interface to implement in your {@link Adapter} to show a popup next to the scroller.
     */
