...
public class FastScrollPopup {
    ...
    public FastScrollPopup(FastScrollRecyclerView rv, AttributeSet attrs) {
        ...
        background             = ResourcesCompat.getDrawable(resources, R.drawable.fastscroll_popup_bg, null);
        ...
        if (bgColor != Color.TRANSPARENT) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                background.setColorFilter(new BlendModeColorFilter(bgColor, BlendMode.SRC_IN));
            }
            else {
