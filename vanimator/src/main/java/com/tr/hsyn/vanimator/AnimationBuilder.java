...
@SuppressWarnings({"WeakerAccess", "UnusedReturnValue", "rawtypes", "IntegerDivisionInFloatingPointContext", "unchecked"})
public class AnimationBuilder {
	...
	public AnimationBuilder and(View... views) {
		
		return viewAnimator.addAnimationBuilder(views);
	}
	
	public AnimationBuilder then(View... views) {
		
		return viewAnimator.then(views);
	}
